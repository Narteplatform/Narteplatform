          ...
          return (
            <div
              ...
              className={cn(
                ...
                highlight ? "border-accent/40 bg-accent/[0.03]" : "border-border"
              )}
            >
              {highlight && (
        ...
        <table className="w-full min-w-[640px] text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/40">
              <th className="px-4 py-3 text-left font-medium">Funzione</th>
              {TIERS.map((t) => (
            ...
            {PLAN_FEATURES.map((row) => (
              <tr key={row.label} className="border-b border-border last:border-0">
                ...
                {TIERS.map((t) => {
                  ...
                  return (
                    <td key={t} className="px-4 py-3 text-center align-top">
                      {v === true ? (
