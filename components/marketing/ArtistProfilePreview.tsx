 ...
 *
 * Annotazioni e scheda formano un blocco unico centrato: la coppia ha una
 * larghezza propria (max-w-4xl) più stretta del contenitore della pagina e le
 * due colonne si stringono verso il centro, invece di appoggiarsi ai due bordi
 * con un vuoto in mezzo. La scheda non sborda più a destra: i numerini devono
 * restare vicini alla riga che li spiega, altrimenti la corrispondenza si
 * perde.
 *
      ...
      <div className="container-narte">
        ...
        <div className="mx-auto mt-12 grid max-w-4xl items-center gap-10 md:mt-16 lg:grid-cols-[minmax(0,1fr)_19rem] lg:-translate-x-6 lg:gap-12 xl:-translate-x-10">
          {/* ANNOTAZIONI. Su mobile stanno sotto la scheda (order-2): prima si
              ...
              attaccate alla scheda che numerano; sotto lg restano centrate
              come la scheda. */}
          <ol className="order-2 max-w-lg justify-self-center space-y-7 lg:order-1 lg:justify-self-end">
